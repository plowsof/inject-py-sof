...
annoying = "C:/Users/Human/Desktop/Raven/SOF PLATINUM/user"
loc_mm_res = os.path.join(annoying,"sofplus/data/mm_res")
loc_mm_res_desktop =  os.path.join(annoying,"sofplus/data/mm_res_desktop")
    ...
    if fgWindow != sofId:
        ...
        if origResDesktop != getLiveDesktop():
            ...
            if not resizeDesktop(origResDesktop,0):
                ...
                cbuf_addText(b';s_nosound 1;say off;')
                resizeDone = 0
